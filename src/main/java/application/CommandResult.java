...
/**
 * Represents the result of handling a single user command. Used in MealMeter to encapsulate both the output message and whether the application should terminate after this command.
 *
